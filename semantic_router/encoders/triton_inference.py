...
class TritonEncoder(DenseEncoder):
    ...
    ```python
    from semantic_router.encoders.ollama import TritonEncoder

    encoder = OllamaEncoder(base_url="http://localhost:11434") # prefer_grpc: bool
    ...
    def __init__(
        ...
        :param base_url: The API endpoint for your TritonServer.
            If not provided, it will be retrieved from the `TRITON_BASE_URL` environment variable.
        :type base_url: str

        :raise ValueError: If the hosted base url is not provided properly or if the triton
